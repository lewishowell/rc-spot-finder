      ...
      <div className="p-6 bg-gray-50 rounded-lg border border-gray-200 text-center">
        ...
        <div className="flex flex-col gap-2 items-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors shadow-sm w-56"
          >
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
              ...
              <rect x="2" y="2" width="20" height="20" rx="5" stroke="url(#ig-form)" strokeWidth="2" />
              <circle cx="12" cy="12" r="4.5" stroke="url(#ig-form)" strokeWidth="2" />
              <circle cx="17.5" cy="6.5" r="1.25" fill="url(#ig-form)" />
            </svg>
            <span className="text-sm font-semibold text-black">Sign in with Instagram</span>
          </button>
        </div>
        <button
          onClick={onCancel}
      ...
      <div>
        ...
        {showInstagramPicker ? (
          <InstagramPhotoPicker
            ...
            onCancel={() => setShowInstagramPicker(false)}
          />
        ) : (
          <>
            <div className="flex items-center gap-2">
              ...
              {session.user.instagramAccessToken && (
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-md hover:from-purple-600 hover:to-pink-600 transition-colors text-sm"
                >
